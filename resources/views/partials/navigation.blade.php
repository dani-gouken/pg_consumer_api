<nav class="mb-4">
    ...
    <div class="flex h-16 justify-between">
      <div class="flex">
        <div class="-ml-2 mr-2 flex items-center md:hidden">
          <!-- Mobile menu button -->
          <button type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500" aria-controls="mobile-menu" aria-expanded="false">
        ...
        <div class="flex flex-shrink-0 items-center">
            <h1 class="font-bold text-primary-950 text-2xl italic">
              <a href="{{ route('service.index') }}">QuickPay</a>
            </h1>
        </div>
      </div>
        <div class="hidden md:ml-6 md:flex md:space-x-8">
          <!-- Current: "border-primary-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
          <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-900">Comment ça marche?</a>
          <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">FAQ</a>
  ...
  <div class="md:hidden hidden" id="mobile-menu">
    <div class="space-y-1 pb-3 pt-2">
      ...
      <a href="#" class="block border-l-4 border-primary-500 bg-primary-50 py-2 pl-3 pr-4 text-base font-medium text-primary-700 sm:pl-5 sm:pr-6">Dashboard</a>
